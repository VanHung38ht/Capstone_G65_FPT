    ...
    var axilInit = {
        ...
        priceRangeSlider: function (e) {
            $('#slider-range').slider({
                ...
                min: 0,
                max: 1000000,
                values: [parseInt(pricefrom) ? pricefrom : 0, parseInt(priceto) ? priceto : 1000000],
                ...
                stop: function (event, ui) {
                    ...
                    var url = "/Home/Service";
                    if (sortby) {
                        url += "?sortby=" + sortby;
                    }
                    if (servicename) {
                        url += (url.includes("?") ? "&" : "?") + "servicename=" + servicename;
                    }
                    if (sevicecategory) {
                        url += (url.includes("?") ? "&" : "?") + "sevicecategory=" + sevicecategory;
                    }
            ...
            if (pricefrom) {
                ...
                var percentageFrom = (parseInt(pricefrom) / 1000000) * 100;

                if (priceto) {
                    var percentageTo = (parseInt(priceto) / 1000000) * 100;
